namespace Ballz
{
   ...
   public class LogicControl
   {
      ...
      protected virtual void raiseMessageEvent (Ballz.Message msg)
      {
         if (Message != null)
            Message (this, msg);
      }
      ...
      {
         if (_message.Kind == Ballz.Message.MessageType.InputMessage) 
         {
      ...
      private void gameLogic(InputMessage msg)
      {
         ...
         case InputMessage.MessageType.ControlsBack:
            state = GameState.menuState;
            raiseMessageEvent (new Ballz.Message (Ballz.Message.MessageType.LogicMessage));//todo: implement LogicMessage and use it here
            break;
         }
      }
      ...
      private void menuLogic (InputMessage msg)
      {
         ...
         case InputMessage.MessageType.ControlsAction:
            ...
            if (activatedMenu != null) {
               ...
               if (activatedMenu.Value.Name == "Play") {
                  ...
                  raiseMessageEvent (new Ballz.Message (Ballz.Message.MessageType.LogicMessage)); // todo: implement LogicMessage class and use it here
                  return;
               }
               prepareMenu (activatedMenu.Value);
               ActiveMenu.Push (activatedMenu.Value);
               raiseMessageEvent (new Ballz.MenuMessage (ActiveMenu.Peek ()));
            }
            break;
         case InputMessage.MessageType.ControlsBack:
         ...
         case InputMessage.MessageType.ControlsUp:
            ...
            if (top.SelectedItem != null) 
            {
               ...
               raiseMessageEvent (new Ballz.MenuMessage (top));
            }
            ActiveMenu.Push (top);
            break;
